...
class MachineInstSelectionAArch64 : IRInstVisitor
{
public:
...
private:
	MachineInstSelectionAArch64(IRFunction* sfunc) : context(sfunc->context), sfunc(sfunc) { }
	...
	void emitInst(MachineInstOpcodeAArch64 opcode, MachineBasicBlock* target);
	...
	MachineOperand newPhysReg(RegisterNameAArch64 name);

...
private:
	...
	void fcmpsd(MachineInst* inst);
	void fcmpss(MachineInst* inst);
	void cmp32_sx8(MachineInst* inst);
	void cmp32_sx16(MachineInst* inst);
	void cmp32_sx32(MachineInst* inst);
	void cmp32_sx64(MachineInst* inst);
	void cmp32_zx8(MachineInst* inst);
	void cmp32_zx16(MachineInst* inst);
	void cmp32_zx32(MachineInst* inst);
	void cmp32_zx64(MachineInst* inst);
	void cmp64_sx8(MachineInst* inst);
	void cmp64_sx16(MachineInst* inst);
	void cmp64_sx32(MachineInst* inst);
	void cmp64_sx64(MachineInst* inst);
	void cmp64_zx8(MachineInst* inst);
	void cmp64_zx16(MachineInst* inst);
	void cmp64_zx32(MachineInst* inst);
	void cmp64_zx64(MachineInst* inst);
